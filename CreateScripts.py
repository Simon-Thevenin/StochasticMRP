					...
					for scenarioasYP in ["False", "True"]:
						for Policy in ["NearestNeighbor", "Re-solve"]: #, "07", "08", "09", "10"]:
								...
								for nrscenar in scenarset: 
										qsub_filename = "job_%s_%s_%s_%s_%s_%s_%s"%(f, m, avg, b, nrscenar, scenarioasYP, Policy )
...
ulimit -v 16000000
mkdir /tmp/thesim
python test.py %s 05 %s %s %s %s %s %s 2000
""" %(f, m, avg,  scenarioasYP, Policy, b, nrscenar,  f, m, avg,  scenarioasYP, Policy, b, nrscenar) )
