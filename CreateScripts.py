						...
						for generation in ["MC", "RMC"]:
							...
							#			avg = True
								for nrscenar in scenarset: 
										qsub_filename = "job_%s_%s_%s_%s_%s_%s_%s_%s"%(f, m, avg, b, nrscenar, scenarioasYP, Policy, generation )
...
""" %(f, m, avg,  scenarioasYP, Policy, b, nrscenar, generation, f, m, avg,  scenarioasYP, Policy, b, nrscenar, generation) )
